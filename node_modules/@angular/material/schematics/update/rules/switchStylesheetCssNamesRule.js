...
exports.Rule = Rule;
class SwitchStylesheetCssNamesWalker extends component_walker_1.ComponentWalker {
    ...
    replaceNamesInStylesheet(node, stylesheetContent) {
        ...
        component_data_1.cssNames.forEach(name => {
            if (!name.whitelist || name.whitelist.css) {
                this.createReplacementsForOffsets(node, name, literal_1.findAll(stylesheetContent, name.replace))
                    .forEach(replacement => {
                    replacements.push({
                        message: `Found CSS class "${chalk_1.red(name.replace)}" which has been renamed to` +
...
exports.SwitchStylesheetCssNamesWalker = SwitchStylesheetCssNamesWalker;
//# sourceMappingURL=switchStylesheetCssNamesRule.js.map